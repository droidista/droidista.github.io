...
val variablesCss = listOf(
    CssDefinition(
        ...
        declarations = mapOf(
            "--nav-text-color-light" to "#000000",
            "--nav-background-color-light" to "#c5eae7",
            "--nav-text-color-dark" to "#FFFFFF",
